...
app.post("/cadastrar_usuario", function(req, resp) {
    ...
    client.db("Prii").collection("usuarios").insertOne(
...
app.post("/logar_usuario", function(req, resp) {
    ...
    client.db("Prii").collection("usuarios").find(
...
app.post("/atualizar_usuario", function(req, resp) {
    ...
    client.db("Prii").collection("usuarios").updateOne(
...
app.post("/remover_usuario", function(req, resp) {
    ...
    // remove do usuário
    client.db("Prii").collection("usuarios").deleteOne(
